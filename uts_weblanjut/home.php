...
<head>
    ...
    <style>
        ...
        .bg {
          /* The image used */
          background-image: url("images/pp_full.jpg");
    ...
    <div class="bg">
        <div class="container">
            <div class="row mb-3 mt-3">
                <div class="col-md-12">
                    <br><br><br><br>
                    <img src="images/2018071038.jpeg" style="border: 1px solid #ddd; border-radius: 50%; padding: 5px;width: 150px; display: block;margin-left: auto;margin-right: auto;">
                    <br>
                    <?php
                        $strSQL = "SELECT * FROM halaman where kode_hlmn='hal001'";
                        $runStrSQL = mysqli_query($conn,$strSQL);
                        while ($hasil=mysqli_fetch_array($runStrSQL)){    
                    ?>
                    <h1 style="text-align: center;color: white"><?php echo $hasil['judul_hlmn'] ?></h1>
                    <br>
                    

                    <br>
                        <h4 style="text-align: center;"><?php echo $hasil['isi_hlmn'] ?></h4>
                    <br>
                    <br>
